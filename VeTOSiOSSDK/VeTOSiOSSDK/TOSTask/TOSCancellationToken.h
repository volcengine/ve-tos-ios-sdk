...
#import <VeTOSiOSSDK/TOSCancellationTokenRegistration.h>
 ...
 */
typedef void(^TOSCancellationBlock)(void);

/*!
 The consumer view of a CancellationToken.
 Propagates notification that operations should be canceled.
 A TOSCancellationToken has methods to inspect whether the token has been cancelled.
 */
@interface TOSCancellationToken : NSObject
