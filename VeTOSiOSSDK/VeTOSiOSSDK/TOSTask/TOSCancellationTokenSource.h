...
@class TOSCancellationToken;

/*!
 TOSCancellationTokenSource represents the producer side of a CancellationToken.
 Signals to a CancellationToken that it should be canceled.
 It is a cancellation token that also has methods
 for changing the state of a token by cancelling it.
 */
@interface TOSCancellationTokenSource : NSObject
 ...
 */
@property (nonatomic, strong, readonly) TOSCancellationToken *token;
