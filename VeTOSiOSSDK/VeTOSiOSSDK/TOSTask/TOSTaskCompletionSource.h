...
@class TOSTask<__covariant ResultType>;

/*!
 A TOSTaskCompletionSource represents the producer side of tasks.
 It is a task that also has methods for changing the state of the
 task by settings its completion values.
 */
@interface TOSTaskCompletionSource<__covariant ResultType> : NSObject
 ...
 */
@property (nonatomic, strong, readonly) TOSTask<ResultType> *task;
